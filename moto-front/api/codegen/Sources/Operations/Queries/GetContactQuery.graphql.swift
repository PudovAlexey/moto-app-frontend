...
public struct GetContactQuery: GraphQLQuery {
  public static let operationName: String = "GetContactQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetContactQuery($search: GetMyContactInput!) { getContact(search: $search) { __typename id isMyContact name } }"#
    ))
  ...
  public struct Data: MotoApi.SelectionSet {
    ...
    public struct GetContact: MotoApi.SelectionSet {
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetContactQuery.Data.GetContact.self
      ] }
